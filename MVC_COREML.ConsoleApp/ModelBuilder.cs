...
using MVC_COREML.Model;

namespace MVC_COREML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\windows.10\Desktop\sentiment labelled sentences\sentiment labelled sentences\amazon_cells_labelled.txt";
        private static string MODEL_FILEPATH = @"C:\Users\windows.10\AppData\Local\Temp\MLVSTools\MVC_COREML\MVC_COREML.Model\MLModel.zip";
